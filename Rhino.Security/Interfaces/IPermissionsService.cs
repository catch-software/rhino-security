...
namespace Rhino.Security.Interfaces
{
    ...
    public interface IPermissionsService
    {
        ...
        /// <summary>
        ///     Get all permissions for the specified user and operation name
        /// </summary>
        ...
        /// <summary>
        ///     Get all permissions for the specified user and operation name(s)
        /// </summary>
        /// <param name="user"></param>
        /// <param name="operationNames"></param>
        /// <returns></returns>
        Permission[] GetPermissionsFor(IUser user, string[] operationNames);
    }
}